...
ALL_MODELS = ['seasonal_naive', 'lightgbm_quantile', 'lightgbm_surd', 'slurp_bootstrap', 'slurp_stockout_aware', 'slurp_surd', 'slurp_surd_stockout_aware', 'deepar', 'deepar_surd']
